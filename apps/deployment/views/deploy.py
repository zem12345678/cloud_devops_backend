...
from commons.custom import RedisObj
...
class VersionView(APIView):
    ...
    def get(self, request, format=None):
        ...
        return OpsResponse(filter(None, result))
...
class DeployView(APIView):
    ...
    def post(self, request, format=None):
        if request.data['excu'] == 'init':
            ...
            return OpsResponse(msg, status=http_status)
            ...
            return OpsResponse(request_status, status=http_status)
